...
function Experience() {
  return (
    <div className='border-b border-contrast pb-20 overflow-x-hidden pt-20 -mt-20' id="experience">
        <motion.h2 
        ...
        <div className='flex flex-col text-center sm:text-left items-center justify-center gap-12'>
            {EXPERIENCES.map((experience, index) => {
                return (
                    <div key={index} className='flex sm:gap-16 flex-col sm:flex-row'>
                        <motion.div 
                            ...
                            <p className='mb-2 text-sm text-gray'>{experience.year}</p>
                        </motion.div>
                        <motion.div 
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            ...
                            <h3 className="mb-2 font-semibold">{experience.role} - 
                                <span className='text-sm text-contrast'> {experience.company}</span>
                            </h3>
